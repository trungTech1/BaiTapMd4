...
<form action="/add-book" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" name="catalog" id="catalog" placeholder=" catalog...">
    </div>
    <div class="mb-3">
        <label for="authors" class="form-label">Author</label>
        <input type="number" class="form-control" name="author" id="authors" placeholder=" author...">
    </div>
    <div class="mb-3">
